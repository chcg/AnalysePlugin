...
{
public:
   //static NppParameters * getInstance() {return _pSelf;}; // Mattes: avoid complete Parameters class
...
private:
   ...
   //static NppParameters *_pSelf; // Mattes: avoid complete Parameters class
