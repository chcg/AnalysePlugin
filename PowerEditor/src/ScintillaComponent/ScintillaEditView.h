...
public:
	...
	virtual ~ScintillaEditView()
	{
		...
		if ((!_refCount)/*&&(_SciInit)*/) // Mattes not in AP
		{
#if 0 // Mattes don't use Parameter Class
...
protected:
	...
	virtual LRESULT scintillaNew_Proc(HWND hwnd, UINT Message, WPARAM wParam, LPARAM lParam); // Mattes make virtual to override
