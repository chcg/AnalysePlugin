...
//#include "UserDefineDialog.h" // Mattes: not in AP
#endif //USER_DEFINE_H
...
// class NppParameters; // Mattes: don't use Parameter class
...
public:
   ...
   // static UserDefineDialog * getUserDefineDlg() {return &_userDefineDlg;}; // Mattes: not in AP
   ...
   void beSwitched() {
      // _userDefineDlg.setScintilla(this); // Mattes: not in AP
   };
...
protected:
   ...
   static int _refCount;
    ...
    // static UserDefineDialog _userDefineDlg; // Mattes: not in AP
